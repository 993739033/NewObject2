...
import com.example.mnkj.newobject.Adapter.JHTHRecordAdapter;
...
//入库记录
public class JHTHRecordActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    @Bind(R.id.jhth_record_recy)
    RecyclerView jhth_record_recy;
    @Bind(R.id.btn_back)
    ImageView btn_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jh_th_record);
    ...
    private void initView() {
        jhth_record_recy.setAdapter(new JHTHRecordAdapter(JHTHRecordActivity.this, bean));
        jhth_record_recy.setLayoutManager(new LinearLayoutManager(this));
        dialog = new ProgressDialog(this);
        dialog.setMessage("正在请求进库退货记录数据");
    ...
    private void bindSp() {
        ...
        String[] s2 = {"包括", "等于"};
        ArrayAdapter adapter = new ArrayAdapter<String>(JHTHRecordActivity.this,
                android.R.layout.simple_spinner_item, Arrays.asList(s1));
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        sp_condition.setAdapter(adapter);
        ArrayAdapter adapter1 = new ArrayAdapter<String>(JHTHRecordActivity.this,
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_search:
                ((JHTHRecordAdapter) jhth_record_recy.getAdapter()).search(sp_condition.getSelectedItem().toString(),
    ...
    private void initSearchView() {
            ...
            public void onFocusChange(View view, boolean b) {
                if (b) {
                    if (layout_more.getVisibility() == View.GONE) {
                        HiddenAnimUtils.newInstance(JHTHRecordActivity.this, layout_more, null, height).toggle();
                    }
                } else {
                    KeyBoard.closeSoftKeyBoard(JHTHRecordActivity.this);
        ...
        jhth_record_recy.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                jhth_record_recy.setFocusable(true);
                jhth_record_recy.setFocusableInTouchMode(true);
                jhth_record_recy.requestFocus();
                return false;
            }
        });
    }
    ...
    private void requestData() {
        ...
        HttpRequest.post(Contance.BASE_URL + "GetRKHistorys.ashx", params, new RequestCallBack<RuKuRecordBean>() {
            @Override
            public void onFailure(Exception e) {
                dialog.dismiss();
                layout_swipe.setRefreshing(false);
                ToastUtils.showShort(JHTHRecordActivity.this, e.getMessage());
            }
            ...
            public void getData(RuKuRecordBean bean) {
                ...
                if (bean.getErrCode() == 0) {
                    ToastUtils.showShort(JHTHRecordActivity.this, "数据获取成功");
                    ((JHTHRecordAdapter) jhth_record_recy.getAdapter()).setBean(bean);
                } else {
                    ToastUtils.showShort(JHTHRecordActivity.this, bean.getErrMsg());
                }
            }
        });
    }
