...
//客户列表数据请求
public class KHSelectActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    @Bind(R.id.btn_back)
    ImageView btn_back;
    @Bind(R.id.layout_swipe)
    SwipeRefreshLayout layout_swipe;
    @Bind(R.id.kh_select_recy)
    RecyclerView kh_select_recy;
    @Bind(R.id.et_search)
    EditText et_search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khselect);
    ...
    private void initView() {
        ...
        kh_select_recy.setLayoutManager(new LinearLayoutManager(this));
        kh_select_recy.setAdapter(new KHSelectAdapter(this, bean));
        dialog.show();
    }
        ...
        HttpRequest.post(Contance.BASE_URL + "GetFBuyPerson.ashx", params, new RequestCallBack<KHBean>() {
            ...
            public void getData(KHBean bean) {
                ...
                if (bean.getErrCode() == 0) {
                    ToastUtils.showShort(KHSelectActivity.this, "数据获取成功");
                    ((KHSelectAdapter) kh_select_recy.getAdapter()).setBean(bean);
                } else {
                    ToastUtils.showShort(KHSelectActivity.this, bean.getErrMsg());
                }
            }
        });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_search:
                ((KHSelectAdapter) kh_select_recy.getAdapter()).search(sp_condition.getSelectedItem().toString()
    ...
    private void bindSp() {
        String[] s1 = {"购买人姓名", "购买人手机", "购买人地址"};
        ArrayAdapter adapter = new ArrayAdapter<String>(KHSelectActivity.this,
    ...
    private void initSearchView() {
            ...
            public void onFocusChange(View view, boolean b) {
                if (b) {
                    if (layout_more.getVisibility() == View.GONE) {
                        HiddenAnimUtils.newInstance(KHSelectActivity.this, layout_more, null, height).toggle();
                    }
                } else {
                    KeyBoard.closeSoftKeyBoard(KHSelectActivity.this);
        ...
        kh_select_recy.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                kh_select_recy.setFocusable(true);
                kh_select_recy.setFocusableInTouchMode(true);
                kh_select_recy.requestFocus();
                return false;
            }
        });
    }
