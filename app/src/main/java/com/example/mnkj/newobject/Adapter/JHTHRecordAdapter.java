 ...
 */
//进货退货记录
public class JHTHRecordAdapter extends RecyclerView.Adapter {
    ...
    public JHTHRecordAdapter(Context context, RuKuRecordBean bean) {
        mContext = context;
        this.bean = bean;
    }
    ...
    class viewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(RuKuRecordBean.DataList bean, String condition, String content) {
            ...
            tv_yxq.setText(DateUtil.changeFormat(bean.getFYxqDate()));
